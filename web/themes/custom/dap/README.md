...
first `bootstrap` directory (e.g. `./dap/bootstrap/bootstrap`), remove the
wrapping `bootstrap` directory. You will only ever need to touch these files if
or when you upgrade your version of the [Bootstrap Framework].

{.alert.alert-warning} **WARNING:** Do not modify the files inside of
`./dap/bootstrap` directly. Doing so may cause issues when upgrading the
[Bootstrap Framework] in the future.

## Overrides {#overrides}
The `./dap/scss/_default-variables.scss` file is generally where you will
...
The `./dap/scss/overrides.scss` file contains various Drupal overrides to
properly integrate with the [Bootstrap Framework]. It may contain a few
enhancements, feel free to edit this file as you see fit.

The `./dap/scss/style.scss` file is the glue that combines:
...
that you should compile to `./dap/css/style.css` (note the same file
